...
public class BlogRestController 
{
  ...
  {
//	  blog.setUsername("Vinod");
//	  blog.setBlogName("DevOps");
//	  blog.setBlogContent("Maven & GitHub");
//	  blog.setLikes(0);
//	  blog.setDislikes(0);
...
//	  blog.setStatus("NA");
  ...
  public ResponseEntity<String> deleteBlog(@PathVariable("blogId")int blogId)
  {
	  ...
	  {
		  return new ResponseEntity<String>("Problem Occured while deleting blog",HttpStatus.NOT_FOUND);
	  }
  }
  ...
  public ResponseEntity<String> incrementLikes(@PathVariable("blogId")int blogId)
  {
	  ...
	  {
		  return new ResponseEntity<String>("Problem Occured while incrementing likes",HttpStatus.NOT_FOUND);
	  }
  }
  ...
  public ResponseEntity<String> incrementDisLikes(@PathVariable("blogId")int blogId)
  {
	  ...
	  {
		  return new ResponseEntity<String>("Problem Occured while incrementing dislikes",HttpStatus.NOT_FOUND);
	  }
  }
  ...
  public ResponseEntity<String> approveBlog(@PathVariable("blogId")int blogId)
  {
	  ...
	  {
		  return new ResponseEntity<String>("Problem Occured while approving blog",HttpStatus.NOT_FOUND);
	  }
  }
  ...
  public ResponseEntity<String> rejectBlog(@PathVariable("blogId")int blogId)
  {
	  ...
	  {
		  return new ResponseEntity<String>("Problem Occured while rejecting blog",HttpStatus.NOT_FOUND);
	  }
  }
